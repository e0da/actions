...
require_literal ".github/workflows/ci-rust.yml" "          prefix-key: v1-rust-nobin"
require_literal ".github/workflows/ci-rust.yml" "          cache-bin: \"false\""
...
require_literal ".github/workflows/release-rust.yml" "          prefix-key: v1-rust-nobin"
require_literal ".github/workflows/release-rust.yml" "          cache-bin: \"false\""
