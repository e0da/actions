...
| `release-elixir.yml` | Separate runner inputs: `validate-runner`, `image-runner`, `publish-runner`. Hosted defaults remain `ubuntu-latest`. Evidence: `.github/workflows/release-elixir.yml:14`, `.github/workflows/release-elixir.yml:18`, `.github/workflows/release-elixir.yml:19`, `.github/workflows/release-elixir.yml:23`, `.github/workflows/release-elixir.yml:24`, `.github/workflows/release-elixir.yml:28`. | Validates release policy, sets up or verifies BEAM, installs production deps, validates the tag against the Mix project version, prepares image tags, optionally pushes a Buildx image, and optionally creates a GitHub Release. Evidence: `.github/workflows/release-elixir.yml:148`, `.github/workflows/release-elixir.yml:195`, `.github/workflows/release-elixir.yml:202`, `.github/workflows/release-elixir.yml:227`, `.github/workflows/release-elixir.yml:230`, `.github/workflows/release-elixir.yml:271`, `.github/workflows/release-elixir.yml:373`, `.github/workflows/release-elixir.yml:415`. | Default image build targets `linux/amd64,linux/arm64` and sets up QEMU before Buildx. Evidence: `.github/workflows/release-elixir.yml:69`, `.github/workflows/release-elixir.yml:73`, `.github/workflows/release-elixir.yml:367`, `.github/workflows/release-elixir.yml:370`. |
...
| `release-elixir.yml` | No Actions artifact upload or download. It can push a GHCR image and optionally create a GitHub Release. Evidence: `.github/workflows/release-elixir.yml:360`, `.github/workflows/release-elixir.yml:373`, `.github/workflows/release-elixir.yml:415`. | Release image. | Keep no-upload default; durable retention lives in GHCR and optional GitHub Release metadata. | Docker layer/image reuse belongs to the image runner and registry, not to Actions artifact retention. |
...
| `release-elixir.yml` | Mix/Rebar/BEAM and Docker Buildx | No persisted Actions cache. The validate job installs production deps per run; the image job relies on Buildx/runner and registry behavior. Evidence: `.github/workflows/release-elixir.yml:227`, `.github/workflows/release-elixir.yml:367`, `.github/workflows/release-elixir.yml:370`, `.github/workflows/release-elixir.yml:373`. | Hosted/default Linux unless caller overrides `validate-runner`, `image-runner`, or `publish-runner`. Evidence: `.github/workflows/release-elixir.yml:14`, `.github/workflows/release-elixir.yml:19`, `.github/workflows/release-elixir.yml:24`. | Release correctness comes before cache economy. Add a cache policy later only with measured BEAM or Buildx benefits and explicit caller opt-in. |
...
- `release-elixir.yml` publishes GHCR images without uploading Actions artifacts.
  Evidence: `.github/workflows/release-elixir.yml:373`,
  `.github/workflows/release-elixir.yml:415`.
